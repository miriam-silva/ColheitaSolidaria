...
const CadastrarRecebedorAdm = () => {
  ...
  const { registerRecebedor, loading, error } = useAuthentication();
    ...
    <div className="cadastro-recebedor-container">
      <div className="container-fluid d-flex justify-content-center align-items-center">
        <div className={`row ${styles.main_box} d-flex`} id="main-box">
          {/* Seção Vermelha */}
          <div
            className={`col-md-6 ${styles.red_section} d-flex align-items-center justify-content-center`}
          >
          ...
          {/* Formulário */}
          <div
            className={`col-md-6 ${styles.form_section} d-flex align-items-center justify-content-center`}
          >
            <div className="w-100">
              ...
              <form className={styles.login_form} onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  value={numFamiliares}
                  onChange={(e) => setNumFamiliares(e.target.value)}
                  required
                />
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  className={`${styles.btn} ${styles.btn_primary} btn-block`}
                  disabled={loading}
                >
                ...
                <div className={`${styles.itens} text-center mt-3`}>
                  <p className={styles.p2}>
                    O recebedor já possui um cadastro? <Link to="/login">Clique aqui para ajudá-lo a fazer login!</Link>
                  </p>
                </div>
              </form>
