                ...
                <img src={fotoPerfil} alt="Perfil" className={`${styles.fotoperfil} rounded-circle mb-2`}/>
                    <h5 className="text-center">Olá, {nomeUsuario || "usuário"}!</h5>
                        ...
                        <div className="w-100 d-flex flex-column gap-2 mt-3">
                            {links.map((link) => (
                                <Link key={link.to} to={link.to} className={`btn btn-outline w-100 ${styles.botoes}`}>
                                    {link.label}
                                </Link>
                            ))}

                        <label htmlFor="fotoPerfilUpload" className={`btn btn-outline w-100 ${styles.botoes}`}>Alterar foto de perfil</label>
